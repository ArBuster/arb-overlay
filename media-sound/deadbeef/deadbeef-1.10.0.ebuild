...
SLOT="0"
KEYWORDS="amd64"
IUSE="aac alac alsa cdda converter cover dts ffmpeg flac +hotkeys lastfm libretro libsamplerate mac mp3 +mpris2 musepack nls notify +nullout opus oss pulseaudio pipewire sc68 shellexec +supereq tta vorbis wavpack wma zip"
...
src_prepare() {
	...
	for i in adplug dumb mms gme mono2stereo psf shn sid soundtouch; do
